---
description: Get started earning yield in 5 minutes
---
...
You need USDC on Ethereum mainnet. Bridge from other chains or buy on an exchange.

### Step 2: Connect to buck.io

1. Go to [buck.io](https://buck.io)
2. Click "Connect Wallet"
3. Select your wallet (MetaMask, WalletConnect, Coinbase Wallet, etc.)

### Step 3: Mint BUCK

1. Enter the USDC amount you want to convert
2. Review the exchange rate (shows how much BUCK you'll receive)
3. Click "Mint"
...
You need roughly equal value of both tokens.

**Example:** $5,000 BUCK + $5,000 USDC = $10,000 LP position

### Step 2: Choose Your Pool

#### Option A: Curve (Recommended)

Curve is optimized for stablecoin swaps with lower slippage.

1. Go to [curve.fi](https://curve.fi)
2. Find the BUCK/USDC pool
3. Click "Deposit"
...
Uniswap offers concentrated liquidity for capital efficiency.

1. Go to [app.uniswap.org](https://app.uniswap.org)
2. Click "Pool" → "New Position"
3. Select BUCK and USDC
4. Set your price range (recommend tight range around $1.00-$1.10)
