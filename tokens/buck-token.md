...
```
Exchange Rate = Total Treasury Value / Total BUCK Supply
```
...
* **Full Value** — Redeem at current exchange rate
* **Reserve Backed** — Liquidity Reserve ensures instant redemptions
...
| **Liquidity Reserve** | Instant redemptions | USDC, USDT |
