---
description: How BUCK delivers ~10% APY through STRC dividends
---
...
```
STRC (Strategy's 10% Preferred Stock)
         │
         │  Pays 10% annual dividends (quarterly)
         ▼
...
*Next: [Monthly Distribution →](distribution.md)*
